        ...
        return [
            {
                ...
                description: 'Government rooftop solar scheme portal enabling citizens to apply for free electricity under the PM Surya Ghar initiative. Features application tracking, document upload, subsidy calculation, and admin approval workflows.',
            ...
            },
            {
                ...
                description: 'Power distribution management portal for BSES Rajdhani (Delhi). Includes consumer billing, outage management, connection request handling, and real-time power load dashboards.',
            ...
            },
            {
                id: 3,
                title: 'PMT 2.0',
                description: 'Project Management Tool v2.0 — a comprehensive platform for tracking tasks, milestones, team assignments, and project progress with interactive Gantt charts and reporting.',
            ...
            },
            {
                ...
                description: 'Real-time solar energy generation monitoring system for Ahasolar. Tracks live plant output, performance ratios, energy yield, fault alerts, and historical generation analytics across multiple sites.',
            ...
            },
            {
                ...
                description: 'Gujarat Energy Development Agency (GEDA) Electric Vehicle portal for managing EV subsidy applications, dealer registrations, vehicle approvals, and state-level EV adoption reporting.',
